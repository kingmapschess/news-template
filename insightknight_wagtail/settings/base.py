"""
Django settings for insightknight_wagtail project.
...
INSTALLED_APPS = [
    "insightknight_wagtail.forms",
    "insightknight_wagtail.home",
    "insightknight_wagtail.images",
    "insightknight_wagtail.navigation",
    "insightknight_wagtail.news",
    "insightknight_wagtail.search",
    "insightknight_wagtail.standardpages",
    "insightknight_wagtail.users",
    "insightknight_wagtail.utils",
...
ROOT_URLCONF = "insightknight_wagtail.urls"
...
WSGI_APPLICATION = "insightknight_wagtail.wsgi.application"
...
WAGTAIL_SITE_NAME = "insightknight_wagtail"
